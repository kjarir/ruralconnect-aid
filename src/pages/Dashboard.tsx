...
import { MapPin, Cloud, CloudRain, CloudSun, Sun, Droplets, Wind, Thermometer, AlertTriangle, ChevronsUp, Tractor, Leaf, ShoppingBag, Phone, VideoIcon, FileText, HelpCircle, User, PiggyBank, HeartPulse } from 'lucide-react';
            ...
            <Card className="border-none shadow-md bg-gradient-to-br from-primary/10 to-background">
              ...
              <CardContent>
                <div className="space-y-2">
                  <Separator />
                  <div className="py-2">
                    <div className="text-sm font-medium mb-1">Upcoming Activities</div>
